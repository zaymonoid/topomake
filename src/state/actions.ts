...
const nextNumber = (topo: Topo): number => {
...
export const deleteRouteAtom = atom(null, (get, set, id: string) => {
  ...
  if (get(selectedRouteIdAtom) === id) set(selectedRouteIdAtom, null);
  if (get(drawingRouteIdAtom) === id) set(drawingRouteIdAtom, null);
});
...
export const appendDrawingPointAtom = atom(null, (get, set, p: Point) => {
...
export const setPointNoCommitAtom = atom(
  null,
